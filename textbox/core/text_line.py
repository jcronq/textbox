...
class TextLine:
    ...
    def start_of_previous_word(self, column_ptr: int) -> Optional[int]:
    ...
    def cursor_position(self, column_ptr: int, width: int = None) -> Position:
    ...
    def split_on_width(self, width: int) -> List["TextLine"]:
    ...
    def replace_character(self, ch: str, column_ptr: int) -> None:
    ...
    def delete(self, column_ptr: int) -> str:
    ...
    def insert(self, other: Union[str, TextSegment, SegmentedTextLine], cursor_ptr: int = None) -> None:
    ...
    def backspace(self, column_ptr: int = None) -> None:
    ...
    def __getitem__(self, item: Union[int, slice]) -> Union[str, "TextLine"]:
